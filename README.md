...
In some cases (e.g. when using cookie authentication), getting streaming URLs require deciphering and may be throttled. Sometimes, YouTube also enforces a "Proof of Origin Token" (PoToken), which is generated by an [Anti-Bot-System](https://botguard.net/en/home).
