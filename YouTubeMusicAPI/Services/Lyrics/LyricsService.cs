    ...
    YouTubeMusicClient client)
{
    ...
    /// <returns>The <see cref="SongVideoLyrics"/> containing the either synced or plain lyrics text.</returns>
    public async Task<SongVideoLyrics> GetAsync(
        string browseId,
        CancellationToken cancellationToken = default)
    {
        ...
        return SongVideoLyrics.Parse(lyricsData);
    }
}